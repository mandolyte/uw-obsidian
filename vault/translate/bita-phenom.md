---
aliases: Biblical Imagery – Natural Phenomena
---
...
Some common [metonymies](figs-metonymy.md) and [metaphors](figs-metaphor.md) from the Bible involving natural phenomena are listed below in alphabetical order. The word in all capital letters identifies an Image that represents an Idea. The specific word of the Image may not appear in every verse that uses the Image, but the text will communicate somehow the concept of the Image.
