...
(3) If the target audience does not realize that it is a metaphor, then change the metaphor to a simile. Some languages do this by adding words such as “like” or “as.” See [Simile](figs-simile.md).<br>
(4) If the target audience would not know the **Image**, see [Translate Unknowns](translate-unknown.md) for ideas on how to translate that image.<br>
...
(4) If the target audience would not know the **Image**, see [Translate Unknowns](translate-unknown.md) for ideas on how to translate that image.
...
To learn more about specific metaphors, see [Biblical Imagery – Common Patterns](bita-part1.md).
