...
From verses 15 through 32, the author uses a specific technique to explain some things. He says there are three things and even four and lists items that exemplify a feature like “small and yet wise.” The numbering is not meant to be so literal, but as a memory device that introduces the items. (See: [[../bible/kt/wise]])

### Themes
There are individual proverbs that run along common themes, often including contrasting elements: wise/foolish, money, lazy/diligent, truth telling, wicked/righteous, sluggard, pride/humility, integrity/crookedness. (See: [[../bible/kt/foolish]] and [[../bible/kt/evil]] and [[../bible/kt/righteous]])