...
This style typically uses pairs of poetic lines that relate to each other in different ways. Usually, poetic lines are said to be “parallel” to each other. A line that is indented farther to the right is paired with the line above it. (See: [[figs-parallelism]])
